...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme shadow rounded">
    <div class="app-brand demo">
        <a href="{{ url('/') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">sitani</span>
        </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <a href="{{ url('produk/produk') }}" class="menu-link">
        ...
        {{-- <li class="menu-item {{ request()->is('admin/statistik*') ? 'active' : '' }}">
            <a href="{{ url('admin/statistik') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-chart"></i>
                <div data-i18n="kategori-produk">Statistik</div>
            </a>
        </li> --}}
    </ul>
</aside>
