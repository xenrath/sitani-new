...
<body>
    ...
    <form id="formAuthentication" class="mb-3" action="{{ url('otp') }}" method="POST">
        @csrf

        <div style="display: flex;flex-direction:column;margin-bottom:10px;"><label for="otp"
                style="text-align: left;margin-bottom:5px;box-sizing:border-box;">Masukan kode OTP</label> <input
                placeholder="xxxxxx" name="kode" type="text" id="kode"
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">sitani</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Selamat Datang di SITANI! 👋</h4>
                        <p class="mb-4">Masukan kode verifikasi untuk melanjutkan.</p>

                        <form class="mb-3" action="{{ url('otp') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="kode" class="form-label">Masukan kode verifikasi</label>
                                <input type="text" class="form-control" id="kode" name="kode"
                                    placeholder="Masukan kode" autofocus value="{{ Session::get('kode') }}" />
                                @error('kode')
