      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- /Logo -->
            <h4 class="mb-2">Berbagai Harga Pangan Pertanian</h4>
            ...
            <form id="formAuthentication" class="mb-3" action="{{ url('register') }}" method="POST">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="role" name="role" aria-label="Role">
                  ...
                  <option value="tengkulak" {{ old('role')=='tengkulak' ? 'selected' : '' }}>Tengkulak</option>
                </select>
              </div>
              ...
              <button class="btn btn-primary d-grid w-100 mt-5">Daftar</button>
            </form>
            <p class="text-center">
