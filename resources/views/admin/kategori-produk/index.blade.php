...
<div class="card">
  <h5 class="card-header d-flex align-items-start justify-content-between">
    Tabel Kategori
    <a href="{{ url('admin/kategori-produk/create') }}" class="btn btn-sm rounded-pill btn-primary">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="{{ url('admin/kategori-produk/' . $kategoriproduk->id . '/edit') }}"
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ url('admin/kategori-produk/' . $kategoriproduk->id) }}" method="POST"
