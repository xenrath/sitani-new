                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($pangans as $key => $pangan)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/riwayat-pangan/' . $pangan->id) }}"
                                    ...
                                    <td>
                                        <a href="{{ url('admin/riwayat-pangan/' . $pangan->id . '/download') }}"
                                        ...
                                        <a href="{{ url('admin/riwayat-pangan/statistik/' . $pangan->id) }}"
                                            class="btn rounded-pill btn-outline-primary btn-sm">
                                            <span class="d-none d-md-block">Statistik</span>
                                            <i class="tf-icons bx bxs-download d-block d-md-none"></i>
                                        </a>
                                    </td>
                                </tr>
