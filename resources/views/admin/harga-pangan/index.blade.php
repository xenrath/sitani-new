...
<div class="card">
  <h5 class="card-header d-flex align-items-start justify-content-between">
    ...
    <div>
      ...
      <a href="{{ url('admin/harga-pangan/export') }}" class="btn btn-sm rounded-pill btn-outline-secondary">
...
<div class="modal fade" id="modalImport" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ url('admin/harga-pangan/import') }}" method="POST" enctype="multipart/form-data">
        @csrf
