    ...
    <div class="row">
                                ...
                                @forelse ($menunggus as $menunggu)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($menunggu->produk->kategori->nama == 'Biasa')
                                                <span class="badge bg-label-success">Biasa</span>
                                            @else
                                                <span class="badge bg-label-primary">Tebas</span>
                                            @endif
                                        </td>
                                        </td>
                                        <td class="text-center">
        ...
        <div class="col-md-6">
            <div class="card">
                <h5 class="card-header d-flex align-items-start justify-content-between">
                    Riwayat
                    {{-- <a href="{{ url('petani/cetak-pdf') }}" target="_blank" class="btn btn-sm rounded-pill btn-primary">
                        <i class="#"></i>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{-- <a href="{{ url('petani/cetak-pdf/' . $riwayat->id) }}" target="_blank"
                                                ...
                                                <i class="tf-icon fa-print"></i>
                                                <span class="d-none d-md-inline">Print</span>
                                            </a> --}}
                                            <a href="{{ url('tengkulak/cetak-pdf/' . $riwayat->id) }}" target="_blank"
                                                class="btn btn-sm rounded-pill btn-primary">
